...
public class GuiCustomConfirmOpenLink extends GuiYesNo {
    ...
    public GuiCustomConfirmOpenLink(GuiYesNoCallback p_i1084_1_, String p_i1084_2_, int p_i1084_3_,
        ...
        super(
                p_i1084_1_,
                I18n.format(
                        (String) (p_i1084_4_ ? "chat.link.confirmTrusted" : "chat.link.confirm"),
                        (Object[]) new Object[0]),
                p_i1084_2_,
                p_i1084_3_);
        this.confirmButtonText = I18n
                .format((String) (p_i1084_4_ ? "chat.link.open" : "gui.yes"), (Object[]) new Object[0]);
